...
function ProfilePageContainer() {
  ...
  return (
    <div className="bgDarkMode min-h-screen">
      <div className="mx-auto max-w-7xl p-4 md:p-8">
        <div className="flex flex-col gap-6 lg:flex-row">
          <main className="flex-1 space-y-6">
            <h2 className="text-xl font-semibold md:text-2xl">My Profile</h2>
            <div className="bgDarkMode rounded-lg border border-gray-200 p-6 shadow-sm">
            ...
            <div className="bgDarkMode rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                  ...
                  <Input disabled readOnly value={data?.username} />
                </div>

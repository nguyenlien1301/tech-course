      ...
      <TableRow key={index}>
        <TableCell>
          <div className="flex flex-col gap-2">
            <div className="h-3 w-44 animate-pulse rounded-md bg-gray-200" />
            <div className="flex items-center gap-5 text-xs">
              <div className="h-2 w-24 animate-pulse rounded-md bg-gray-200" />
              <div className="size-2 animate-pulse rounded-full bg-gray-200" />
              <div className="h-2 w-24 animate-pulse rounded-md bg-gray-200" />
            </div>
          </div>
        </TableCell>
...
export default SkeletonTableComment;
